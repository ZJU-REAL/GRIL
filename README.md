...
## 🗞️ News
- **`2026-04-25`**: Code released on Github.
- **`2026-04-21`**: Paper released on arXiv.

---

## 🛠️ Installation / Quick Start

This section provides a minimal end-to-end setup to run training and evaluation.

### 1) Environment setup (Conda)

We strongly recommend using Conda to manage the environment for dependency compatibility.
...
Since `verl` is a local package in this repository, install it manually in editable mode:
...
This script sets required environment variables and starts training with the base configuration.
...
@misc{qiu2026pausefabricatetraininglanguage,
      ...
      author={Yiwen Qiu and Linjuan Wu and Yizhou Liu and Yuchen Yan and Xu Tan and Jin Ma and Yao Hu and
              Daoxin Zhang and Wenqi Zhang and Weiming Lu and Jun Xiao and Yongliang Shen},
      year={2026},
      eprint={2604.19656},
      archivePrefix={arXiv},
      primaryClass={cs.CL},

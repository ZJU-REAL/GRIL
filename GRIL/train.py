...
def add_dependency_and_validate_config(config):
    ...
    assert "qwen" in config.model_path.lower() or (not config.enable_response_mask) or "llama" in config.model_path.lower(), \
    ...
    if not ray.is_initialized():
        ...
        ray.init(runtime_env={
            'env_vars': {
                ...
                # "RAY_DEBUG": "legacy"
                # "RAY_DEBUG_POST_MORTEM": "1"# used here for simpler breakpoint()
            }
        },

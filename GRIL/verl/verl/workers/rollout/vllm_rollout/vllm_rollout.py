    ...
    def generate_sequences(self, prompts: DataProto, **kwargs) -> DataProto:
        ...
        if not do_sample:
            kwargs = {
                ...
                "stop":["</answer>", "</ answer>", "<|endoftext|>"],
                "stop_token_ids": [eos_token_id],# if greedy, only 1 response
            }
        elif is_validate:
            # TODO: try **
            kwargs = {
                ...
                "repetition_penalty": 1.2,
                "stop":["</answer>", "</ answer>", "<|endoftext|>"],
                "stop_token_ids": [eos_token_id],# if validate, already repeat in ray_trainer
            }
